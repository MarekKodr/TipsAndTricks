...
public class QueriesGenerated {
  ...
  public static Object propertyMacro_GetPropertyValue_2982883097094645221(final PropertyMacroContext _context) {
    String path = ((AbstractModule) _context.getOriginalInputModel().getModule()).getDescriptorFile().getParent().getPath() + "/tips/IdeTipsAndTricks.xml";
    return path;
  }
  ...
  public static Object propertyMacro_GetPropertyValue_2982883097092662943(final PropertyMacroContext _context) {
    ...
    String path = ((AbstractModule) _context.getOriginalInputModel().getModule()).getDescriptorFile().getParent().getPath() + "/tips/resources_" + SPropertyOperations.getString(_context.getNode(), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")).toLowerCase();

    File tmpFile = new File(path);
    if (!(tmpFile.isDirectory()) || !(tmpFile.exists())) {
      tmpFile.mkdir();
    }
    return path + "/" + SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(_context.getNode()), MetaAdapterFactory.getConcept(0xff3ef7856efd437aL, 0xb0d5407497433041L, 0x21ef157f5ac36f61L, "TipsAndTricks.structure.TT_Tip")), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + ".html";
