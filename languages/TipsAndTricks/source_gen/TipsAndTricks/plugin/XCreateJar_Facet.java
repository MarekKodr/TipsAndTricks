...
public class XCreateJar_Facet extends IFacet.Stub {
  private static final Logger LOG = LogManager.getLogger(XCreateJar_Facet.class);
  private List<ITarget> targets = ListSequence.fromList(new ArrayList<ITarget>());
  private IFacet.Name name = new IFacet.Name("TipsAndTricks.XCreateJar");
  public XCreateJar_Facet() {
    ListSequence.fromList(targets).addElement(new XCreateJar_Facet.Target_doJar());
  }
  ...
  public IPropertiesPersistence propertiesPersistence() {
    return new XCreateJar_Facet.TargetProperties();
  }
  public static class Target_doJar implements ITargetEx {
    private static final ITarget.Name name = new ITarget.Name("TipsAndTricks.XCreateJar.doJar");
    public Target_doJar() {
    }
    public IJob createJob() {
      return new IJob.Stub() {
        ...
        public IResult execute(final Iterable<IResource> rawInput, final IJobMonitor monitor, final IPropertiesAccessor pa, @NotNull final ProgressMonitor progressMonitor) {
          Iterable<IResource> _output_kkxwxv_a0a = null;
          ...
          switch (0) {
                    ...
                    new DeltaReconciler(tres.delta()).visitAll(new FilesDelta.Visitor() {
                      ...
                      private void doJar(final IFile file) {
                        ...
                        if (name.endsWith(".html.xml")) {
                          LoggingRuntime.logMsgView(Level.INFO, file.getPath().toString(), XCreateJar_Facet.class, null, null);
                        }
            ...
            default:
              ...
              return new IResult.SUCCESS(_output_kkxwxv_a0a);
          }
        }
      };
    }
