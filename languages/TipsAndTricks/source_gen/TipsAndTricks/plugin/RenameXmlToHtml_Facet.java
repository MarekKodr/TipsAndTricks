...
public class RenameXmlToHtml_Facet extends IFacet.Stub {
  ...
  private IFacet.Name name = new IFacet.Name("TipsAndTricks.RenameXmlToHtml");
  ...
  public static class Target_doRename implements ITargetEx {
    private static final ITarget.Name name = new ITarget.Name("TipsAndTricks.RenameXmlToHtml.doRename");
